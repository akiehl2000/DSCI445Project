...
Can we predict top fantasy point performers in the NFL?
- Took data from the 2018-2020 seasons and used these to predict performances in 2021.
- Used various models to predict and wrangled up the best for each response variable for testing.

Are there players that perform very well that you could get on your team with a later draft pick?
