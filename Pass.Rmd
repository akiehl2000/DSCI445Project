...
for(k in 1:K) {
 ...
 bag_fit = randomForest(PassYds ~ . - PassTD - PassInt - FL, data = trn, mtry = ncol(trn)-4, importance = TRUE)
}
...
```{r}
# Linear regression will be used for PassYds
randomForest(PassYds ~ . - PassTD - PassInt - FL, data = train_data, mtry = ncol(train_data)-4, importance = TRUE) %>%
