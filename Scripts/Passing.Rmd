...
for(k in 1:K) {
 ...
 bag_fit = randomForest(PassYds ~ . - PassTD - PassInt - FL - PassDrops - BadThrow - BadPer - YdsLost - Rate - Sk - FirstDPassPer, data = trn, mtry = ncol(trn)-9, importance = TRUE)
}
importance(bag_fit)
...
randomForest(PassYds ~ . - PassTD - PassInt - FL - PassDrops - BadThrow - BadPer - YdsLost - Rate - Sk - FirstDPassPer, data = train_data, mtry = ncol(train_data)-9, importance = TRUE) %>%
