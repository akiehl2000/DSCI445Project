...
View(rquery.cormat(train_data[,-c(2:4, 7)])$r)
```

Removing `FirstDRec`, `RecYBC`, `YBCPerR`, `DropPerRec`, and `YACPerR` yielded reasonable VIF scores and a diagnostically semi-sound linear model. 
```{r}
